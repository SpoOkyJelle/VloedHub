...
var WEATHER_CODES = {
  ...
  61: ["Regen", "🌧️"], 63: ["Regen", "🌧️"], 65: ["Zware regen", "🌧️"],
  66: ["IJzel", "🌧️"], 67: ["IJzel", "🌧️"],
  71: ["Sneeuw", "🌨️"], 73: ["Sneeuw", "🌨️"], 75: ["Zware sneeuw", "🌨️"],
  77: ["Sneeuwkorrels", "🌨️"],
  80: ["Buien", "🌦️"], 81: ["Buien", "🌦️"], 82: ["Zware buien", "🌦️"],
  85: ["Sneeuwbuien", "🌨️"], 86: ["Sneeuwbuien", "🌨️"],
  95: ["Onweer", "⛈️"], 96: ["Onweer met hagel", "⛈️"], 99: ["Onweer met hagel", "⛈️"]
};
  ...
  https.get(url, function(res) {
    ...
    res.on("end", function() {
      try {
        ...
        var code = WEATHER_CODES[cur.weather_code] || ["Onbekend", "❓"];
        var precip = null;
